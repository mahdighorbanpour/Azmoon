...
namespace Azmoon.Tests
{
    ...
    public class AzmoonTestModule : AbpModule
    {
        public AzmoonTestModule(AzmoonEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<AzmoonDbContext>>();
