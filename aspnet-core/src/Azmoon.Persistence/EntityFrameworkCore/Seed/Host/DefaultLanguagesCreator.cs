...
namespace Azmoon.Persistence.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        private readonly AzmoonDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = AzmoonConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AzmoonDbContext context)
        {
            _context = context;
        }
