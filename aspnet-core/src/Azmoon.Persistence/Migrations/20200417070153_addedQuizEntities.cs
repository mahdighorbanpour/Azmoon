        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongDescription = table.Column<string>(maxLength: 1000, nullable: false),
                    ImageUri = table.Column<string>(maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hint = table.Column<string>(maxLength: 1000, nullable: true),
                    Marks = table.Column<int>(nullable: false, defaultValue: 0),
                    QuestionType = table.Column<int>(nullable: false),
                    CategoryId = table.Column<int>(nullable: false),
                    RandomizeChoices = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
