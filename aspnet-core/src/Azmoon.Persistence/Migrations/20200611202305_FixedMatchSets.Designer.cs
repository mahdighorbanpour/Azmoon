...
namespace Azmoon.Persistence.Migrations
{
    ...
    [Migration("20200611202305_FixedMatchSets")]
    partial class FixedMatchSets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Azmoon.Core.Quiz.Entities.Blank", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Azmoon.Core.Quiz.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Azmoon.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Azmoon.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Azmoon.Core.Quiz.Entities.Blank", b =>
                {
                    b.HasOne("Azmoon.Core.Quiz.Entities.Choice", "Choice")
                        .WithMany("Blanks")
            ...
            modelBuilder.Entity("Azmoon.Core.Quiz.Entities.QuizQuestion", b =>
                {
                    ...
                    b.HasOne("Azmoon.Core.Quiz.Entities.Quiz", "Quiz")
                        .WithMany("Questions")
