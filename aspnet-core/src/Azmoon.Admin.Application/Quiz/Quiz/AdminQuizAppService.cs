...
namespace Azmoon.Admin.Application.Quiz.Quiz
{
    ...
    public class AdminQuizAppService : AsyncCrudAppService<Core.Quiz.Entities.Quiz, QuizDto, Guid, PagedQuizResultRequestDto, CreateUpdateQuizDto, CreateUpdateQuizDto>, IAdminQuizAppService
    {
